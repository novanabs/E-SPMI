            ...
            <li class="nav-item">
              ...
              <li class="nav-item menu-open"> <!---menu-open -->
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="1_penetapan.html" class="nav-link active">
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Penetapan</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item"><a href="#">E-SPMI</a></li>
                  <li class="breadcrumb-item"><a href="#">FKIP</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Penetapan</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
