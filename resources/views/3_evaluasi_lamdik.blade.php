...
<html lang="en">
  ...
  <head>
    ...
    <style>
        ...
        .stats { display: flex; gap: 32px; flex-wrap: wrap; justify-content: center; }
        .card { background: #e3eafc; border-radius: 8px; padding: 24px; flex: 1 1 300px; box-shadow: 0 2px 8px rgba(0,0,0,0.05); }
      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="./index.html" class="brand-link">
            ...
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">E-SPMI FKIP</span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
            ...
            <li class="nav-item">
              ...
              <li class="nav-item menu-open"> <!---menu-open -->
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="3_evaluasi.html" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Evaluasi</p>
                    </a>
                  </li>
              ...
              <!-- AKREDITASI -->
              <li class="nav-item">
                <a href="akreditasi.html" class="nav-link">
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Evaluasi Kriteria LAMDIK 2.0</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item"><a href="#">E-SPMI</a></li>
                  <li class="breadcrumb-item"><a href="#">FKIP</a></li>
                      ...
                      <div class="card-body">
                        ...
                        <form id="kriteriaForm">
                          <div class="mb-3">
                            ...
                            <div class="form-check">
                              ...
                              <label class="form-check-label">
                                Pilihan 1: Dosen pembimbing memberikan bimbingan magang ≥ 3 kali, terdokumentasi dengan sangat baik.
                              </label>
                            </div>
                            <div class="form-check">
                            ...
                            <div class="form-check">
                              ...
                              <label class="form-check-label">
                                Pilihan 4: Dosen pembimbing tidak memberikan bimbingan magang, hanya menguji di akhir masa magang.
                              </label>
                            </div>
                          </div>
                          ...
                          <div class="mb-3">
                            ...
                            <input type="url" class="form-control" id="bukti" name="bukti" placeholder="Masukkan link bukti jika ada">
                          </div>
