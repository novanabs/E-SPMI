...
@section('content')
    ...
    @if (!isset($tahun))
        @include('EvaluasiLamdik._year_cards', [
            ...
            'subtitle' =>
                'Pilih tahun audit untuk mengisi borang Akreditasi Mutu Internal (AMI). Data setiap tahun disimpan secara terpisah.',
    ...
    @else
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="pelaksanaan-tab" data-bs-toggle="tab" data-bs-target="#pelaksanaan"
                    type="button" role="tab" aria-controls="pelaksanaan" aria-selected="false">Syarat Unggul</button>
            </li>
            <li class="nav-item" role="presentation">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card shadow-sm mb-3">
                            ...
                            <div class="d-flex align-items-center mb-1">
                                <div style="width: 15px; height: 15px; background:#ffc107; border-radius:3px;"
                                    class="me-2">
                                </div>
                            ...
                            <div class="d-flex align-items-center mb-1">
                                <div style="width: 15px; height: 15px; background:#dc3545; border-radius:3px;"
                                    class="me-2">
                                </div>
                            ...
                            <div class="nav-grid" id="nav-container">
                                ...
                                @foreach ($data as $item)
                                    ...
                                    <button class="nav-grid-btn nav-item-btn {{ $borderClass }}"
                                        ...
                                        data-content="{{ $item->indikator }}"
                                        data-kriteria="{{ $item->kriteria->name }}"
                                    ...
                                    <div class="text-end">
                                        ...
                                        @elseif ($memenuhi3)
                                            <span class="badge bg-warning text-dark fs-6 px-3 py-2"><i
                                                    class="bi bi-exclamation-triangle-fill me-1"></i>Terpenuhi 3
                                                Tahun</span>
                                        @else
            ...
            <div class="tab-pane fade" id="evaluasi" role="tabpanel" aria-labelledby="evaluasi-tab">
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-header py-2 d-flex justify-content-between">
                        ...
                        <button class="btn btn-sm btn-primary ms-auto" onclick="previewPdf()" hidden>
                            Export PDF
                        </button>
                    </div>
            ...
            <div class="modal-dialog modal-xl modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="{{ url('/export/export-pdf?tahun=' . $tahun) }}" target="_blank"
