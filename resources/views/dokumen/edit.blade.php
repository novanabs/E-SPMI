...
<div class="page-header">
    ...
    <div class="page-subtitle">
        ...
        Perbarui dokumen pendukung untuk mendukung
...
<div class="form-card">
    ...
    <div class="info-box">
        ...
        <div>
            ...
            <div class="info-desc">
                ...
                Pastikan data dokumen yang diperbarui memiliki
                informasi yang valid, jelas, dan dapat diakses
                dengan baik.
    ...
    <form action="{{ route('dokumen.update', $data->id) }}"
          method="POST">
