    ...
    <form action="{{ route('dokumen.store') }}" method="POST">
        ...
        <div class="form-group mb-3">
            ...
            <textarea type="text" class="form-control @error('deskripsi')
                is-invalid
            @enderror"
                id="deskripsi" name="deskripsi" placeholder="Masukkan Deskripsi">{{ old('deskripsi') }}</textarea>
        </div>
        <div class="form-group">
            ...
            <input type="text"
                ...
                is-invalid
            @enderror"
                id="link_dokumen" name="link_dokumen" placeholder="Masukkan Link Dokumen" value="{{ old('link_dokumen') }}">
            @error('link_dokumen')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
