...
@section('content')
    ...
    <div class="page-header d-flex justify-content-between align-items-center flex-wrap gap-3">
        ...
        <div>
            ...
            <div class="page-title">
                Dokumen Penetapan {{ auth()->user()->homebase }}
            </div>

            <div class="page-subtitle">
                Kelola dokumen penetapan
            </div>

        </div>

        <a href="{{ route('penetapan.create') }}" class="btn-add">
    ...
    <div class="table-card">
        ...
        <div class="table-responsive">
            ...
            <table id="penetapanTable" class="table dataTable align-middle">
                    ...
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ $item->link_bukti_dokumen }}" target="_blank" class="btn-link-custom">
                            ...
                            <td>
                                ...
                                <div class="action-group">
                                    ...
                                    <a href="{{ route('penetapan.edit', $item->id) }}" class="btn-action btn-edit">
