...
<div class="page-header">
    ...
    <div class="page-title">
        Edit Laporan Pengendalian
    </div>

    <div class="page-subtitle">

        Perbarui laporan pengendalian sebagai bagian dari proses
...
<div class="form-card">
    ...
    <div class="info-box">
        ...
        <div>
            ...
            <div class="info-title">
                Edit Dokumen Pengendalian
            </div>

            <div class="info-desc">

                Pastikan link laporan terbaru dapat diakses dan sesuai
                dengan dokumen pengendalian yang telah diperbarui.
    ...
    <form action="{{ route('pengendalian.update', $data->id) }}"
          method="POST">
