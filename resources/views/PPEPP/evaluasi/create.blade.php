        ...
        <form action="{{ route('evaluasi.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <select class="form-select @error('jenis_laporan') is-invalid @enderror" name="jenis_laporan"
                    ...
                    <option value="AMI" {{ old('jenis_laporan') == 'AMI' ? 'selected' : '' }}>
                        AMI
                    </option>

                    <option value="Monev_jurusan" {{ old('jenis_laporan') == 'Monev_jurusan' ? 'selected' : '' }}>
                        Monev Jurusan
                    </option>

                    <option value="Survey" {{ old('jenis_laporan') == 'Survey' ? 'selected' : '' }}>
                        Survey
                    </option>
