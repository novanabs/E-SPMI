...
<div class="form-card">
    ...
    <form action="{{ route('evaluasi.update', $data->id) }}"
          method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name"
                placeholder="Masukkan nama laporan (opsional)" value="{{ old('name', $data->name) }}">
        ...
        <div class="form-group">
            ...
            <select class="form-select @error('jenis_laporan') is-invalid @enderror"
                ...
                <option value="AMI"
                    {{ old('jenis_laporan', $data->jenis_laporan) == 'AMI' ? 'selected' : '' }}>
                    AMI
                </option>

                <option value="Monev_jurusan"
                    {{ old('jenis_laporan', $data->jenis_laporan) == 'Monev_jurusan' ? 'selected' : '' }}>
                    Monev Jurusan
                </option>

                <option value="Survey"
                    {{ old('jenis_laporan', $data->jenis_laporan) == 'Survey' ? 'selected' : '' }}>
                    Survey
                </option>
