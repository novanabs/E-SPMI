...
<div class="page-header">
    ...
    <div class="page-title">
        Tambah Laporan Peningkatan
    </div>

    <div class="page-subtitle">

        Tambahkan laporan peningkatan mutu sebagai bagian dari
...
<div class="form-card">
    ...
    <div class="info-box">
        ...
        <div>
            ...
            <div class="info-desc">
                ...
                Pastikan link laporan peningkatan dapat diakses
    ...
    <form action="{{ route('peningkatan.store') }}"
          method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text"
                   ...
                   value="Laporan Peningkatan {{ auth()->user()->homebase }}"
                   readonly>
