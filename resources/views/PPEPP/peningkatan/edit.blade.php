...
<div class="page-header">
    ...
    <div class="page-title">
        Edit Laporan Peningkatan
    </div>

    <div class="page-subtitle">

        Perbarui laporan peningkatan mutu sebagai bagian dari
        proses tindak lanjut dan pengembangan berkelanjutan
...
<div class="form-card">
    ...
    <div class="info-box">
        ...
        <div>
            ...
            <div class="info-title">
                Edit Dokumen Peningkatan
            </div>

            <div class="info-desc">

                Pastikan link laporan terbaru dapat diakses
                dan sesuai dengan dokumen peningkatan mutu
    ...
    <form action="{{ route('peningkatan.update', $data->id) }}"
          method="POST">
        ...
        @foreach (['Tahun', 'Semester Ganjil', 'Semester Genap'] as $i => $option)
            ...
            <div class="form-check">
                ...
                <input class="form-check-input @error('jenis') is-invalid @enderror"
                       ...
                       id="jenis_{{ $i }}"
                       value="{{ $option }}"
                       {{ old('jenis', $data->jenis ?? 'Tahun') === $option ? 'checked' : '' }}>
