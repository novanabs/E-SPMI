    ...
    <div class="page-header d-flex justify-content-between align-items-center flex-wrap gap-3">
        ...
        <div>
            ...
            <div class="page-title">
                Laporan Pelaksanaan {{ auth()->user()->homebase }}
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if ($item->link_bukti_kerjasama)
                                    <a href="{{ $item->link_bukti_kerjasama }}" class="btn-link-custom btn-doc"
                                        target="_blank">
                            ...
                            <td>
                                ...
                                <div class="action-group">
                                    ...
                                    <a class="btn-action btn-edit" href="{{ route('pelaksanaan.edit', $item->id) }}">
