        ...
        <form action="{{ route('pelaksanaan.update', $data->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name"
                    placeholder="Masukkan nama laporan" value="{{ old('name', $data->name) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-select @error('bidang') is-invalid @enderror" id="bidang" name="bidang">
                    ...
                    <option value="Pendidikan" {{ old('bidang', $data->bidang) == 'Pendidikan' ? 'selected' : '' }}>1)
                        Pendidikan</option>
                    <option value="Penelitian" {{ old('bidang', $data->bidang) == 'Penelitian' ? 'selected' : '' }}>2)
                        Penelitian</option>
                    <option value="Pengabdian kepada Masyarakat"
                        {{ old('bidang', $data->bidang) == 'Pengabdian kepada Masyarakat' ? 'selected' : '' }}>3) Pengabdian
            ...
            <div class="form-group">
                ...
                <input type="number" min="2000" max="{{ date('Y') + 10 }}"
                    ...
                    placeholder="Masukkan tahun" value="{{ old('tahun', $data->tahun) }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('nama_mitra') is-invalid @enderror" id="nama_mitra"
                    name="nama_mitra" placeholder="Masukkan nama mitra" value="{{ old('nama_mitra', $data->nama_mitra) }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('link_bukti_kerjasama') is-invalid @enderror"
                    id="link_bukti_kerjasama" name="link_bukti_kerjasama" placeholder="Masukkan"
