...
@section('content')
    ...
    <div class="page-header">
        ...
        <div class="page-subtitle">
            Tambahkan laporan pelaksanaan dan dokumen kerjasama
        </div>
        ...
        <form action="{{ route('pelaksanaan.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name"
                    placeholder="Masukkan nama laporan" value="{{ old('name') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('nama_mitra') is-invalid @enderror" id="nama_mitra"
                    name="nama_mitra" placeholder="Masukkan nama mitra" value="{{ old('nama_mitra') }}">
