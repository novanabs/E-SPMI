...
@section('content')
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="{{ url('/export/export-pdf/perbandingan/upm/' . $user->id) }}" target="_blank" class="btn btn-sm" style="background: #173b70; color: #fff;">
    ...
    <script>
        function previewPdf() {
            ...
            fetch('/export/preview/perbandingan/upm/{{ $user->id }}')
                .then(res => res.text())
