...
@section('content')
    ...
    {{-- AUDITOR NAME MAPPING --}}
    @if (isset($auditorNameMap) && count($auditorNameMap) > 0)
        <div class="d-flex flex-wrap gap-3 mb-3 p-3 bg-white rounded-3 shadow-sm border">
            <span class="fw-semibold text-nowrap" style="color: #173b70;"><i class="bi bi-person-vcard me-1"></i>Auditor:</span>
            @foreach ($auditorNameMap as $label => $name)
                <span class="badge bg-light text-dark border px-3 py-2 fs-6">{{ $label }} : {{ $name }}</span>
            @endforeach
        </div>
    @endif
        ...
        <div class="tab-pane fade show active" id="evaluasi" role="tabpanel" aria-labelledby="evaluasi-tab">
                ...
                <div class="col-md-5 d-flex">
                    <div class="card shadow-sm h-100 w-100 border-0 rounded-3">
                        <div class="card-header py-2 rounded-top-3" style="background: #173b70; color: #fff;">
                            <h5 class="mb-0"><i class="bi bi-building me-1"></i>Penilaian Mandiri {{ $user->homebase ?? '' }}</h5>
                        </div>
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div>
                    ...
                    <a class="btn btn-sm ms-2" style="background: #173b70; color: #fff;" href="{{ route('evaluasi_diri_jurusan.edit.custom', $user->id) }}">
        ...
        <div class="tab-pane fade" id="chart" role="tabpanel" aria-labelledby="chart-tab">
            <div class="card shadow-sm">
                <div class="card-header py-2 d-flex justify-content-between" style="background: #173b70; color: #fff;">
                    <h5 class="mb-0"><i class="bi bi-graph-up me-1"></i>Hasil Akreditasi {{ $user->homebase ?? '' }}</h5>
                    <div>
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header" style="background: #173b70; color: #fff;">
                    <h5 class="modal-title"><i class="bi bi-file-earmark-pdf me-2"></i>Preview Laporan Evaluasi Diri {{ $user->homebase ?? '' }}</h5>
        ...
        document.querySelectorAll(".auditor-pill").forEach(btn => {
            btn.addEventListener("click", function() {
                ...
                document.querySelectorAll(".nilai-auditor").forEach(td => {
                    ...
                    valSpan.dataset.raw = score !== null && score > 0 ? score : 0;
