            ...
            <li class="nav-item">
              ...
              <li class="nav-item menu-open"> <!---menu-open -->
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="2_pelaksanaan.html" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Pelaksanaan</p>
                    </a>
                  </li>
                  ...
                  <li class="nav-item">
                    <a href="4_pengendalian.html" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Pengendalian</p>
                    </a>
                  </li>
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Pengendalian</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item"><a href="#">E-SPMI</a></li>
                  <li class="breadcrumb-item"><a href="#">FKIP</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Pengendalian</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
        ...
        <div class="app-content">
          <!--begin::Container-->
            ...
            <!--begin::Container-->
            <!-- ISI KONTEN -->
             <!-- Section Upload Rencana Tindak Lanjut -->
