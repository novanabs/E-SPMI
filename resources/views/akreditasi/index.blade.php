...
<div class="page-header d-flex justify-content-between align-items-center flex-wrap gap-3">
    ...
    <div>
        ...
        <div class="page-subtitle">
            Data akreditasi jurusan FKIP ULM
        </div>
    ...
    @if (auth()->check() && auth()->user()->role == 'admin_FKIP')
        ...
        <a href="{{ route('akreditasi.create') }}" class="btn-add">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="document-date">
                                {{ \Carbon\Carbon::parse($item->tanggal_sk)->translatedFormat('d M Y') }}
                            </div>
...
$(document).ready(function() {
    ...
    $('#akreditasiTable').DataTable({
        ...
        language: {
            ...
            emptyTable: "Belum ada data akreditasi"
